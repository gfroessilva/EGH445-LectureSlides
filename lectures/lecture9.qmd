...
## Limitations of LQR: Control Saturation {.smaller}
...
## Quadratic Forms and Positiveness {.smaller .scrollable}
...
[$P\succeq 0$ means that $P$ is positive semi-definite, i.e. $x^T P x \geq 0$ for all $x \in \mathbb{R}^n$.]{.fragment}
...
## LQR Cost Function and Tuning {.smaller}
