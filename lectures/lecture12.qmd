...
- Common development boards
    - [Arduino, Teensy, etc.]{.fragment fragment-index=1}
    - [dSpace DS1104, MicroLabBox, etc.]{.fragment fragment-index=2}
:::

::: {.columns}
::: {.column}
[![](images/tensy.jpg){height="300px"}]{.fragment fragment-index=1}
:::
::: {.column}
[![](images/dSpaceDS1104.jpeg){height="300px"}]{.fragment fragment-index=2}
:::
:::
